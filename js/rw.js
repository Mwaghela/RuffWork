...
function createDynamicCard(component){
    ...
    dynamicContent += "<div class='float-right' onclick=\"deleteRuffWork(\'"+component.id+"\')\"><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash' viewBox='0 0 16 16'>";
